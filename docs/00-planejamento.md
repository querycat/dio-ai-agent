...
- **Caso de uso (para que o agente serve, que problemas ele pode resolver):**
- **Persona e tom de voz (personalidade do agente):**
- **Arquitetura:** Diagrama mostrando o fluxo de um usuário perguntando e o agente, consultando a base de conhecimento, validando e por fim respondendo.
